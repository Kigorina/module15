...
class NavigationTest(BaseCase):
    ...
    def test_03_find_items(self):
        self.get(self.base_url)
        # кликаем на ссылку для выбора региона
        self.click('//*[@id="top-navigation-links"]/ul/li[1]/a')
        # кликаем чтобы выбрать регион
    ...
    def test_04_basket(self):
        ...
        # сохраняем название четвертого товара страницы
    ...
    def test_05_change_region(self):
        ...
        self.get(self.base_url + '/dolce-gabbana/s/1495')
        # получаем цену со страницы по умолчанию
        home_price = self.get_text('//article[1]/a/div[2]/p[3]/span[2]')
        # переход в раздел языковых параметров и их смены
        self.click('//*[@id="top-navigation-links"]/ul/li[1]/a')
